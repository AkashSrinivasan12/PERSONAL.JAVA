...
public class Update_Teacher extends JFrame implements ActionListener,ItemListener{
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b1){
            ...
            String e = t6.getText();
            String p = t7.getText();
            String qry = "update Teacher set name='"+n+"',gender='"+g+"',address='"+a+"',state='"+s+"',city='"+c+"',email='"+e+"',phone='"+p+"'   where id="+c2.getSelectedItem();
        ...
        if(ae.getSource()==b2){
            try{
                conn c1 = new conn();
                c1.s.executeUpdate("delete from Teacher where id="+c2.getSelectedItem());
    ...
    public void itemStateChanged(ItemEvent ie){
        try{
            conn c1 = new conn();
            ResultSet rs = c1.s.executeQuery("select * from eacher where id="+c2.getSelectedItem());
