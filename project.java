...
public class project extends JFrame implements ActionListener {
    ...
    project()
    {
        ...
        JMenu m1 = new JMenu("Teacher");
        m1.setForeground(Color.blue);
        m1.setFont(new Font("monospaced", Font.BOLD, 20));
    
        JMenuItem t1 = new JMenuItem("Add New Teacher");
        ...
        JMenuItem t4 = new JMenuItem("List of Teacher");
        ...
        mb.add(edit);
        JMenuItem s1 = new JMenuItem("Update Salary of Teacher");
        ...
        JMenuItem s2 = new JMenuItem("Update Teacher Details");
        ...
        JMenu rep =new JMenu("Teacher's Report");
